...
TARGET_SPECIFIC_HEADER_PATH := device/kttech/s200/include
...
-include vendor/kttech/s200/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := s200
...
BOARD_EGL_CFG := device/kttech/s200/configs/egl.cfg
...
TARGET_PREBUILT_KERNEL := device/kttech/s200/prebuilt/kernel
